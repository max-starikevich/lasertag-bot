...
const pl: MappedTranslation = {
  ...
  AI_WRONG_RESPONSE: 'Sztuczna inteligencja nie zdołała odpowiedzieć z odpowiednimi danymi',
  AI_IN_PROGRESS: 'Proszę czekać. Sztuczna inteligencja pracuje nad tym zapytaniem',
