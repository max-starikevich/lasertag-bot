...
const ru: MappedTranslation = {
  ...
  AI_TEAMS_COMMAND_DESCRIPTION: 'Создать команды с помощью искусственного интеллекта',
  AI_WRONG_RESPONSE: 'Искусственный интеллект не смог ответить с подходящими данными',
  AI_IN_PROGRESS: 'Пожалуйста, подождите. Искусственный интеллект обрабатывает этот запрос',
