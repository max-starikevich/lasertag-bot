...
https://github.com/TiagoDanin/Telegraf-Test
      ...
      getChatMember: () => {
		...
		this.expressApp.get('/bot:token/:method', handleRequest)
		this.expressApp.post('/bot:token/:method', handleRequest)

		this.expressServer = this.expressApp.listen(this.options.port, () => {
